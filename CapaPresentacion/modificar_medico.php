...
if (isset($_POST['idMedico'])) {
    ...
    $consulta = "SELECT tpersona.nombre, tpersona.apellido, tpersona.fecha_nacimiento FROM tpersona JOIN tmedico ON tpersona.id_persona = tmedico.id_persona WHERE tmedico.id_medico = ?";
