...
<div class="pagetitle">
  <h1>ADMINISTRAR ASIGNACION USUARIO-ROL</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="index.php">Home</a></li>
      <li class="breadcrumb-item">Accesso y seguridad</li>
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">ASIGNACION DE ROLES-USUARIOS </h5>
          <p>Control de acceso y seguirdad al sistema: ASIGNACION, REVOCACION.</p>
        </div>
      </div>
                  ...
                  <!-- *******botones de modal******* -->
          <a href="insert_asignacion.php" class="btn btn-primary">ASIGNAR</a>
          <a href="del_rol.php" class="btn btn-danger">REVERTIR</a>
...
<div class="card">
        <div class="card-body">
          ...
          <table class="table">
            ...
            <?php
            foreach ($tabladatos as $datorol){
              ?>
            <tr>

              <td><?php echo $datorol['id_asignacion']; ?> </td>
       
              <td><?php echo $datorol['nombre_usuario']; ?> </td>
